...
namespace AWSIM.TrafficSimulation
{
    ...
    public class NPCVehicleSpawner
    {
        ...
        {
            // バイクの場合はスポーン位置を上にオフセット
            Vector3 spawnPosition = npcVehicleSpawnPoint.Position;
            if (prefab.name.Contains("Motorcycle"))
            {
                spawnPosition.y += 0.3f; // バイクを0.5m上にスポーン
            }
            ...
            //Layer �ύX (Child��Collider��Layer��ύX���Ȃ���Boxcast�������Ȃ��j
